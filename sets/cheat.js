...
var cheat = [];
cheat[0] = { title:'Cheat Trash', imageFile:'Corp_back.png', player:runner, cardType:"event", playCost:0,
	Resolve: function()
	{
		...
		if (choices.length > 0)
		{
			var decisionCallback = function(params) {
				Trash(params.card, true, function(){ //true means can be prevented
					RemoveFromGame(this); //card is removed from game after resolving
				},this); 
			};
			DecisionPhase(corp,choices,decisionCallback,"Cheat","Cheat",this,"trash");
		}
		else RemoveFromGame(this); //card is removed from game after resolving
	}
};
cheat[1] = { title:'Cheat Tags', imageFile:'Corp_back.png', player:runner, cardType:"event", playCost:0,
	Resolve: function()
	{
...
cheat[2] = { title:'Cheat Drain', imageFile:'Corp_back.png', player:runner, cardType:"event", playCost:0,
	Resolve: function()
	{
...
cheat[3] = { title:'Cheat Enrich', imageFile:'Corp_back.png', player:runner, cardType:"event", playCost:0,
	Resolve: function()
	{
